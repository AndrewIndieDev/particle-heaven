...
#pragma warning restore UDR0001 // Domain Reload Analyzer
    ...
    public static T RandomElement<T>(this IList<T> list, int startIndex, int endIndex)
    {
        return list.Count > 0 ? list[UnityEngine.Random.Range(startIndex, endIndex)] : default;
    }
    ...
    public static string SanitizeAuthenticationName(this string str) {
        str = str.Replace('<', ' ');
        str = str.Replace('>', ' ');
        str = str.Replace('_', ' ');
        str = str.Trim();
    ...
    public static string SanitizeTagLine(this string str)
    {
